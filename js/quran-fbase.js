...
function getRenderFuncFB(params) {
  var elem = params.elem;
  var selector = params.selector;
  var trans = params.trans;
  var verse = params.verse|0;
  ...
  window[func] = function(x) {
     // late resolution of elem 
    var vnum = params.chapter*1000 + verse;
    if (!elem) {
      elem = document.querySelector(params.selector);
    }
    innerHTML = '<div class="ayahBoxNum">'  + params.chapter + ':' + verse;
...
function getDataFirebase(params) {
  ...
  var selector = params.selector;
  var trans = params.trans;
  var func = getRenderFuncFB(params);
  var end;
  var src = "https://quran-aae08.firebaseio.com/verses.json?print=pretty&orderBy=\"$key\"";
  var vnum = chapter*1000 + verse;

  src += "&startAt=\""+vnum+"\"&limitToFirst="+count+"&callback="+func;
  return src
}
